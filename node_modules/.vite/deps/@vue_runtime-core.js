...
import { isString, isFunction as isFunction2, isPromise, isArray as isArray2, NOOP as NOOP2, getGlobalThis, extend as extend2, EMPTY_OBJ, toHandlerKey, looseToNumber, hyphenate, camelize, isObject as isObject2, isOn, hasOwn as hasOwn2, isModelListener, capitalize as capitalize2, toNumber, hasChanged as hasChanged2, remove, isSet, isMap as isMap2, isPlainObject, isBuiltInDirective, invokeArrayFns, isRegExp, isGloballyAllowed, NO, def as def2, isReservedProp, EMPTY_ARR, toRawType as toRawType2, makeMap as makeMap2, normalizeClass, stringifyStyle, normalizeStyle, isKnownSvgAttr, isBooleanAttr, isKnownHtmlAttr, includeBooleanAttr, isRenderableAttrValue } from "@vue/shared";
...
function validateProps(rawProps, props, instance) {
  ...
  for (const key in options) {
    ...
    validateProp(
      ...
      !hasOwn2(rawProps, key) && !hasOwn2(rawProps, hyphenate(key))
    );
  }
}
